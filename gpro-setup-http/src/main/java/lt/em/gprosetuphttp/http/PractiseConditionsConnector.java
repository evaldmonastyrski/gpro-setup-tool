...
import lt.em.gpro.model.ImmutablePractiseConditions;
...
class PractiseConditionsConnector {
    @NotNull private static final String RAIN_GIF_NAME = "wRain.gif";
    @NotNull private final WebDriver webDriver;

    PractiseConditionsConnector(@NotNull WebDriver webDriver) {
        this.webDriver = webDriver;
    }

    @NotNull
    PractiseConditions parsePractiseConditions() {
