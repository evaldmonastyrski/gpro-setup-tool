...
import lt.em.gpro.model.ImmutableFacilities;
import lt.em.gpro.model.ImmutableStaff;
import lt.em.gpro.model.ImmutableStaffAndFacilities;
...
class FacilitiesConnector {
    private static final int LAST_STAFF_FACILITIES_INDEX = 28;
    @NotNull
    private final WebDriver webDriver;

    FacilitiesConnector(@NotNull WebDriver webDriver) {
        this.webDriver = webDriver;
    }

    @NotNull
    StaffAndFacilities parseStaffAndFacilities() {
