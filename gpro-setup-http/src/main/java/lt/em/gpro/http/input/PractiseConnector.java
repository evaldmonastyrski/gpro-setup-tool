...
import lt.em.gpro.model.output.ImmutablePractise;
...
public class PractiseConnector {
    ...
    public PractiseConnector(@NotNull WebDriver webDriver) {
        this.webDriver = webDriver;
    }

    @NotNull
    public Practise parsePractise() {
